Задачи второго этапа для Школы программистов HeadHunter.
...
Решение задачи представлено в файле Points.java.
...
Решение задачи представлено в файле Numbers.java
